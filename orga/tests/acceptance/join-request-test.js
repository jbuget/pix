...
module('Acceptance | join-request', function(hooks) {
  ...
  module('When user submit the join request form', function() {
    ...
    test('it should fail if the SCO organization does not have an email', async function(assert) {
      ...
      // then
      assert.contains('Nous n’avons pas d’adresse e-mail de contact associé à votre établissement, merci de contacter le support pour récupérer votre accès.');
    });
